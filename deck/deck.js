...
// ================= 9. Рынок =================
{
  ...
  const head = ['Страна', '9 класс в год', 'Школ', 'Рынок EdTech'];
  ...
  const rows = [
    ['Россия', '1,71 млн', '~40 000', '154 млрд ₽ в 2025-м, +12 % за год'],
    ['Казахстан', '360 тыс.', '8 048', '45 млрд ₸ в 2025-м, +20 % в 2024-м'],
    ['Узбекистан', '622 тыс.', '11 118', '126 млрд сумов, +94 % за год'],
  ];
  rows.forEach((r, i) => {
    const y = 2.28 + i * 0.46;
  ...
  s.addText('В России профориентация обязательна в школах с 1 сентября 2023 года — курс «Россия — мои горизонты», 8,4 млн школьников. Требование есть, инструмента нет.', {
