...
// ================= 4. Почему не работают =================
{
  ...
  const rows = [
    ...
    ['Карьерный консультант', '5–15 тысяч рублей за сессию, разово, не сопровождает три года.'],
...
// ================= 9. Бизнес-модель =================
{
  ...
  const payers = [
    [C.green, 'Родитель', '590 ₽ / мес', 'Спокойствие: у ребёнка есть план, и он им занимается. Дешевле одной сессии консультанта.'],
    [C.blue, 'Школа', '25 000 ₽ / год за класс', 'Карты всех девятиклассников, кабинет куратора, отчёт «куда смотрят наши ученики».'],
