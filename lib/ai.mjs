...
Правила:
1. Линия — это пересечение двух (иногда трёх) интересов ученика, а не один «главный» интерес. Каждая линия — своя комбинация. Поле interests линии — id из списка интересов, который ты сам сформируешь из ответов. Линий должно быть 4 или 5 — покажи разные направления, включая неочевидные (например, биология + монтаж → научные медиа).
2. Интересы (interests): 3–5 станций-стартов. title — ОДНО слово, максимум два, как название станции метро: «Шахматы», «Биология», «Figma», «Монтаж». Никаких «интерес к…», «увлечение…», «…и аналитика». id — латиницей, desc — одна фраза о том, как это проявляется у ученика (из его ответов). Ответ «кем видят родители» — НЕ интерес ученика: линию на нём не строй, можно упомянуть в why как контраст «своё vs навязанное».
